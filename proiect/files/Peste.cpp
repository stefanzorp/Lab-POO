...
Peste::Peste(): m_nume("nu avem"), m_familie("nu avem"), m_zona("nu avem"), m_masa(0) {}; 
...
Peste::Peste(const Peste& p): m_nume(p.m_nume), m_familie(p.m_familie), m_zona(p.m_zona), m_masa(p.m_masa), m_id_peste(p.m_id_peste) {}; 
